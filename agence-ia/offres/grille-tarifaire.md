# Grille tarifaire AutomaIA (Jour 24)

> Grille assumée pour annoncer un prix sans hésiter. Modèle : forfait de mise en place (une fois) + abonnement mensuel (récurrent).
> Prix CLIENT en euros. Niveaux à valider, puis figés. Voix : brand_voice.md.
> 3 paliers pour créer un effet d'ancrage : entrée / cœur (cible) / premium.

---

## La grille en un coup d'œil

| | **Assistente Email** (entrée) | **Studio Automatizzato** (più richiesto) | **Studio 360** (premium) |
|---|---|---|---|
...
## La logique d'ancrage (pourquoi cette structure)
...
3. **Le palier d'entrée enlève la peur de s'engager.** À 600 €, l'Assistant Email est un "oui" facile. Une fois le client satisfait, monter vers Studio Automatizzato devient naturel (c'est ton chemin de montée en gamme).

> Règle : toujours présenter les 3, dans l'ordre premium → milieu → entrée à l'oral, ou les 3 côte à côte à l'écrit. Ne jamais présenter un seul prix isolé, il n'a aucun point de comparaison.

---

## Comment annoncer le prix sans hésiter
...
- Prix pensés pour le marché italien (libéraux), positionnement valeur, début d'activité. À ajuster avec l'expérience et les premières références.
- Le récurrent (abonnement) est la priorité stratégique : c'est lui qui crée un revenu prévisible.
- À traduire en italien pour le site et les propositions (vouvoiement "Lei").
