# brand_voice.md — Ma voix de marque
...
4. **Honnête et directe**
   Pas de survente, pas de bullshit marketing. Si quelque chose ne s'applique pas à eux, je le dis. La crédibilité passe avant l'enthousiasme.

---

## Niveau de langage

- **Vouvoiement, mais ton chaleureux et humain.** En italien le "Lei", en français/anglais le vouvoiement. Je garde le sérieux et le respect dû à des professionnels libéraux, mais sans la froideur corporate. Je m'adresse à une personne, pas à une entreprise anonyme.
- Concrètement : vouvoiement + phrases proches, bienveillantes, qui montrent que je comprends leur quotidien. Sérieux sur le fond, chaleureux sur la forme.

---

## Ce que je dis (à privilégier)
...
## Ce que j'évite (interdits)

- Le jargon technique (IA, API, automation, workflow, machine learning...)
- La survente : "révolutionnaire", "magique", "100% garanti", "explosez vos résultats"
- Les promesses vagues non chiffrées
- Le ton condescendant : ce sont des experts dans leur domaine, je les respecte
- Les tirets longs (em dashes) dans les écritures, comme dans tout mon contenu

---

## Exemples avant / après

**Mauvais (trop technique, survente) :**
