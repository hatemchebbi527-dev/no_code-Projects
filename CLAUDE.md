...
Ce workspace est le Jarvis personnel de Hatem. Il a été créé avec le Jarvis Starter Kit pour servir d'assistant IA personnel au quotidien.
...
Je m'appelle Hatem et je vis à Rimini, en Italie. Je suis actuellement réceptionniste de nuit dans un hôtel, en pleine reconversion professionnelle vers l'indépendance dans le domaine de l'intelligence artificielle.

Mon objectif est de devenir freelance en IA, de lancer une agence spécialisée dans l'automatisation des processus d'entreprise et les services digitaux liés à l'IA, et d'atteindre la liberté financière et sociale.

Mes objectifs prioritaires actuels sont de décrocher mon premier client freelance en IA et de lancer un projet concret d'automatisation pour une entreprise locale.

À long terme, lancer ma propre agence IA et quitter mon emploi actuel.
