...
- Workflows n8n opérationnels : veille RSS vers Google Sheet, publication Instagram automatisée (API Meta), et assistant de réponse aux emails (Gmail Trigger vers API Claude vers brouillon Gmail, avec filtrage des vrais mails clients via node IF). **Testé et validé de bout en bout. Premier actif démontrable en prospection.** Améliorations à ajouter (voir HISTORY 2026-06-23) : threading du brouillon, robustesse du parsing JSON, envoi résumé/urgence vers un canal externe.
