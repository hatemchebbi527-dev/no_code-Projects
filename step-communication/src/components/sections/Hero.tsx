...
const line1 = ["Trasformiamo", "i", "brand"];
const line2 = ["in", "esperienze."];
  ...
  return (
    ...
    >
      ...
      <CinematicImage
        ...
        overlay={false}
      />
      {/* Overlay leggibilità: scuro in basso e a sinistra */}
      <div
        aria-hidden
            ...
            {line2.map((w, i) => (
              <span key={i} className="mr-[0.28em] inline-flex overflow-hidden align-bottom">
                <motion.span
                  ...
                  className={cn(
                    "inline-block",
                    w.startsWith("esperienze") && "italic text-gradient-accent pr-[0.08em]"
                  )}
                >
                  {w}
                </motion.span>
