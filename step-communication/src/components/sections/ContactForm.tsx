...
const projectTypes = [
  ...
  "Brand activation",
  "Eventi aziendali / Lancio prodotti",
    ...
    return (
      <div className="flex flex-col items-center justify-center rounded-3xl border border-line bg-bg-subtle p-12 text-center">
        ...
        <p className="mt-3 max-w-md text-fg-muted">
          Ti rispondiamo entro 24 ore con una prima proposta. Per urgenze,
          chiamaci pure allo {siteConfig.phone}.
        </p>
        <button
          type="button"
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <Field label="Azienda">
          <input name="azienda" placeholder="La tua azienda" className={cn(inputBase, "h-12")} />
        </Field>
      ...
      <div className="mt-5">
        <Field label="Il tuo progetto" required>
          <textarea
            ...
            required
            rows={5}
            placeholder="Raccontaci obiettivi, date indicative e cosa hai in mente..."
