...
/**
 * "Clienti & progetti" - portfolio cinematografico.
          ...
          <SectionHeading
            ...
            title={
              <>
                ...
                <br className="hidden sm:block" /> <span className="italic text-gradient-accent">per noi.</span>
              </>
            }
          />
          <Reveal>
            <Link href="/clienti" className={buttonVariants({ variant: "secondary" })}>
              Tutti i clienti
            ...
            <Reveal key={project.slug} delay={(i % 3) * 0.08} className="h-full">
              ...
              >
                ...
                <div className="relative z-10 flex items-start justify-between">
                  ...
                  <ArrowUpRight className="h-5 w-5 text-white/75 transition-all duration-300 group-hover:text-accent group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                </div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-4 flex items-baseline gap-2 border-t border-white/20 pt-4">
                    ...
                    <span className="text-sm text-white/70">{project.metric.label}</span>
                  </div>
                </div>
              </Link>
            </Reveal>
