...
export const metadata: Metadata = {
  title: "Servizi — eventi, MICE e marketing esperienziale",
  description:
    "I servizi di Step Communication: tour e spettacoli, eventi MICE, marketing esperienziale, brand activation, eventi aziendali e consulenza strategica.",
  alternates: { canonical: "/servizi" },
  openGraph: {
    title: "Servizi — Step Communication",
    description:
      "Tour e spettacoli, eventi MICE, marketing esperienziale, brand activation, eventi aziendali e consulenza strategica.",
  ...
  return (
    <>
      ...
      <PageHero
        ...
        title={
          <>
            Sei modi di trasformare un brand in{" "}
            <span className="italic text-gradient-accent">esperienza.</span>
          </>
        }
        intro="Dalla strategia all'ultimo dettaglio in scena, copriamo l'intero ciclo di vita dell'esperienza di marca. Scegli il punto di partenza, alla regia pensiamo noi."
      />
